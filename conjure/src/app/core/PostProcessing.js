...
{  
    constructor(renderer, scene, camera)
    {
        ...
        this.renderer.toneMappingExposure = 1.0//Math.pow(1.30, 4.0);

        this.renderScene = new SSAARenderPass(this.scene, this.camera);
    ...
    {
        this.renderer.clear();
        this.camera.layers.set(POSTPROCESSING.BLOOM_SCENE)
        this.composer.render();
        
        this.renderer.clearDepth();
        this.camera.layers.set(POSTPROCESSING.ENTIRE_SCENE)
    ...
    addOutlines()
    {
        this.objectSelectedPass = new OutlinePass(new THREE.Vector2(window.innerWidth, window.innerHeight), this.scene, this.camera);
        ...
        this.objectHoverPass = new OutlinePass(new THREE.Vector2(window.innerWidth, window.innerHeight), this.scene, this.camera);
