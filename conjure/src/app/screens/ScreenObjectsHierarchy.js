...
{  
    ...
    updateObjects()
    {
        ...
        this.jsonTree.updateTree(this.screenManager.conjure.world.getObjects(), this.updateObjects);
    }

    groupingCallback(newParent, newChild)
    {
        if(!this.screenManager.conjure.world.realm.getObjectManager().groupObjects(newParent, newChild))
            return false;
        return true
    }
