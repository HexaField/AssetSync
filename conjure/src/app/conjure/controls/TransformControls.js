...
var TransformControls = function ( camera, domElement ) {
    ...
    this.isAttached = function (object) {
	...
	this.pointerHover = function ( pointer ) {
		...
		if ( this.objects.length === 0 || this.dragging === true || ( pointer.button !== undefined && pointer.button !== 0 ) ) return;
    ...
    this.updateObjectMatrixWorld = function (obj)
    {
        // console.log(obj)
