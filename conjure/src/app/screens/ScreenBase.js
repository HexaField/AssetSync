...
import { easyPlane, easyLine } from '../core/util/MeshTemplates.js'
...
{  
    constructor(screenManager, args = {})
    {
        ...
        this.screenManager.conjure.world.cameraScreenAttach.add(this.group); // this is for attaching to the camera follow
